...
begin
  ...
  into v_order_id, v_order_status, v_created_at;
...
revoke all on function public.create_order_with_items(integer, uuid, jsonb)
from public;

grant execute on function public.create_order_with_items(integer, uuid, jsonb)
